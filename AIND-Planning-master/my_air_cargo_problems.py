...
def air_cargo_p1() -> AirCargoProblem:
    ''' The Optimal Path for Air Cargo Problem 1 has length 6 and is shown below
        Load(C1, P1, SFO)
        Load(C2, P2, JFK)
        Fly(P1, SFO, JFK)
        Fly(P2, JFK, SFO)
...
def air_cargo_p2() -> AirCargoProblem:
    ...
    ''' The Optimal Path for Air Cargo Problem 2 has length 9 and is shown below
        Load(C1, P1, SFO)
        Load(C2, P2, JFK)
        Load(C3, P3, ATL)
        Fly(P1, SFO, JFK)
...
def air_cargo_p3() -> AirCargoProblem:
    ...
    ''' The Optimal Path for Air Cargo Problem 3 has length 12 and is shown below
        Load(C1, P1, SFO)
        Load(C2, P2, JFK)
        Fly(P1, SFO, ATL)
        Load(C3, P1, ATL)
